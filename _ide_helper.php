...
namespace Illuminate\Support\Facades {
     ...
     */        class Request {
         ...
         *
         * @see \Hybridly\HybridlyServiceProvider::registerMacros()
         * @static 
         */        public static function isHybrid()
        {
                        return \Illuminate\Http\Request::isHybrid();
        }
                    /**
        ...
        {
                        return \Illuminate\Http\Request::isPartial();
        }
            }
            /**
     * 
     ...
     */        class Route {
         ...
         * @static 
         */        public static function hybridly($uri, $component, $properties = [])
        {
                        return \Illuminate\Routing\Router::hybridly($uri, $component, $properties);
        }
            }
            /**
     * 
...
namespace Illuminate\Testing {
     ...
     */        class TestResponse {
         ...
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::hdd()
         * @param string|int|null $path
         * @return \Illuminate\Testing\TestResponse 
         * @static 
         */        public static function hdd($path = null)
        {
                        return \Illuminate\Testing\TestResponse::hdd($path);
        }
                    /**
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::assertNotHybrid()
         * @return \Illuminate\Testing\TestResponse 
         * @static 
         */        public static function assertNotHybrid()
        {
                        return \Illuminate\Testing\TestResponse::assertNotHybrid();
        }
                    /**
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::assertHybrid()
         * @param \Closure|null $callback
         * @return \Illuminate\Testing\TestResponse 
         * @static 
         */        public static function assertHybrid($callback = null)
        {
                        return \Illuminate\Testing\TestResponse::assertHybrid($callback);
        }
                    /**
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::assertHasHybridProperty()
         * @param string $key
         * @param mixed $length
         * @param \Closure|null $callback
         * @return \Illuminate\Testing\TestResponse 
         * @static 
         */        public static function assertHasHybridProperty($key, $length = null, $callback = null)
        {
                        return \Illuminate\Testing\TestResponse::assertHasHybridProperty($key, $length, $callback);
        }
                    /**
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::assertMissingHybridProperty()
         * @param string $key
         * @param mixed $length
         * @param \Closure|null $callback
         * @return \Illuminate\Testing\TestResponse 
         * @static 
         */        public static function assertMissingHybridProperty($key, $length = null, $callback = null)
        {
                        return \Illuminate\Testing\TestResponse::assertMissingHybridProperty($key, $length, $callback);
        }
                    /**
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::assertHybridProperty()
         * @param string|int $key
         * @param mixed|null $expected
         * @return \Illuminate\Testing\TestResponse 
         * @static 
         */        public static function assertHybridProperty($key, $expected)
        {
                        return \Illuminate\Testing\TestResponse::assertHybridProperty($key, $expected);
        }
                    /**
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::assertHybridProperties()
         * @param array $keys
         * @return \Illuminate\Testing\TestResponse 
         * @static 
         */        public static function assertHybridProperties($keys)
        {
                        return \Illuminate\Testing\TestResponse::assertHybridProperties($keys);
        }
                    /**
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::assertHybridPayload()
         * @param string|int $key
         * @param mixed|null $expected
         * @return \Illuminate\Testing\TestResponse 
         * @static 
         */        public static function assertHybridPayload($key, $expected)
        {
                        return \Illuminate\Testing\TestResponse::assertHybridPayload($key, $expected);
        }
                    /**
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::assertHybridView()
         * @param string $view
         * @return \Illuminate\Testing\TestResponse 
         * @static 
         */        public static function assertHybridView($view)
        {
                        return \Illuminate\Testing\TestResponse::assertHybridView($view);
        }
                    /**
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::assertHybridDialog()
         ...
         * @return \Illuminate\Testing\TestResponse 
         * @static 
         */        public static function assertHybridDialog($properties = null, $view = null, $baseUrl = null, $redirectUrl = null)
        {
                        return \Illuminate\Testing\TestResponse::assertHybridDialog($properties, $view, $baseUrl, $redirectUrl);
        }
                    /**
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::assertHybridVersion()
         * @param string $version
         * @return \Illuminate\Testing\TestResponse 
         * @static 
         */        public static function assertHybridVersion($version)
        {
                        return \Illuminate\Testing\TestResponse::assertHybridVersion($version);
        }
                    /**
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::assertHybridUrl()
         * @param string $url
         * @return \Illuminate\Testing\TestResponse 
         * @static 
         */        public static function assertHybridUrl($url)
        {
                        return \Illuminate\Testing\TestResponse::assertHybridUrl($url);
        }
                    /**
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::getHybridPayload()
         * @return array 
         * @static 
         */        public static function getHybridPayload()
        {
                        return \Illuminate\Testing\TestResponse::getHybridPayload();
        }
                    /**
         * 
         *
         * @see \Hybridly\Testing\TestResponseMacros::getHybridProperty()
         * @param string $key
         * @return mixed|null 
         * @static 
         */        public static function getHybridProperty($key)
        {
                        return \Illuminate\Testing\TestResponse::getHybridProperty($key);
        }
            }
    }
...
namespace Spatie\LaravelData {
     ...
     */        class Lazy {
         ...
         * 
         *
         * @see \Hybridly\HybridlyServiceProvider::packageBooted()
         * @param \Closure $value
         * @return \Hybridly\Support\Data\PartialLazy 
         * @static 
         */        public static function partial($value)
        {
                        return \Spatie\LaravelData\Lazy::partial($value);
        }
            }
    }
